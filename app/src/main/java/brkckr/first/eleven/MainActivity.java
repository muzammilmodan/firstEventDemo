...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivOpenCreateLine = findViewById(R.id.ivOpenCreateLine);
        ...
        ivOpenCreateLine.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, CreateLineUpActivity.class);
    ...
    /**
     * adds players to the field. with perticular position
     *
     * @param firstEleven
     */
